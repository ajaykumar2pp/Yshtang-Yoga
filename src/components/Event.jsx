  ...
  return (
    <div>
         <div className="heading mt-20  mb-10">
            <h1 className="text-purple-800 text-center text-4xl font-bold underline ">Upcoming Event</h1>
        </div>
          <section className="blog-card grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-10 mt-10">
<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="/event">
        <img className="rounded-t-lg" src="../../public/Yoga-relax.jpg" alt="" />
    </Link>
    <div className="p-5">
        <Link to="/event">
            <h5
                className="mb-2 text-2xl font-bold tracking-tight hover:text-purple-800 text-gray-900 dark:text-white">
                Relax Your Body</h5>
        </Link>
...
<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to="/event">
        <img className="rounded-t-lg" src="../../public/Yoga-children.jpg" alt="" />
    </Link>
    <div className="p-5">
        <Link to="/event">
            <h5
                className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white hover:text-purple-800">
                Yoga For Children</h5>
        </Link>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology
            acquisitions of 2021 so far, in reverse chronological order.</p>
        <Link to="/event"
...
<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
        <Link to="/event">
            <h5
                className="mb-2 text-2xl font-bold tracking-tight hover:text-purple-800 text-gray-900 dark:text-white">
                How to Become a Morning Person</h5>
        </Link>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology
            acquisitions of 2021 so far, in reverse chronological order.</p>
        <Link to="/event"
...
<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
        <Link to="/event">
            <h5
                className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white hover:text-purple-800">
                How to Change Your Daily Routine</h5>
        </Link>
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology
            acquisitions of 2021 so far, in reverse chronological order.</p>
        <Link to="/event"
